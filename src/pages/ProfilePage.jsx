...
import ActionModal from "../components/ui/ActionModal"; // Importar o novo modal
...
const ProfilePage = () => {
	...
	const openModal = (title, message, onConfirm, type = "confirmation") => {
		setModalContent({ title, message, onConfirm, type });
		setIsModalOpen(true);
	};
		...
		openModal(
			...
			async () => {
				try {
					...
					// Otimização: atualiza o estado localmente em vez de refazer o fetch
					setAppointments(
